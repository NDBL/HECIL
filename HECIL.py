...
parser = argparse.ArgumentParser(description='HECIL : Hybrid Error Correction of Long Reads using Iterative Learning')
# Required arguments
...
parser.add_argument('-k','--confidence_threshold', help='Percentile to categorize low and high confidence corrections', default='95')
